...
func CalcStartEndTime(startTime, endTime int64, term, totalTerm, billType, paymentMonth int, firstMonth, firstDay int, isTermNormal bool) (termStartTime, termEndTime int64) {
	...
	case 1:
		...
		if isTermNormal {
			...
			termStartTime, termEndTime = MakeUpDays2(startTime, firstMonth, firstDay, paymentMonth)
		} else {
			termEndTime = endTime
		}
	case 2:
...
func TestTestCalcStartEndTimeStr() {
	...
	TestCalcStartEndTimeStr("2018-04-26", "2019-05-18", 1, 12, 1, 1, 1, 18, true)
	TestCalcStartEndTimeStr("2018-04-26", "2019-05-18", 2, 12, 2, 1, 1, 18, true)
	TestCalcStartEndTimeStr("2018-04-26", "2019-05-18", 3, 12, 2, 1, 1, 18, true)
	TestCalcStartEndTimeStr("2018-04-26", "2019-05-18", 4, 12, 2, 1, 1, 18, true)
	TestCalcStartEndTimeStr("2018-04-26", "2019-05-18", 5, 12, 2, 1, 1, 18, true)
	TestCalcStartEndTimeStr("2018-04-26", "2019-05-18", 6, 12, 2, 1, 1, 18, true)
	TestCalcStartEndTimeStr("2018-04-26", "2019-05-18", 7, 12, 2, 1, 1, 18, true)
	TestCalcStartEndTimeStr("2018-04-26", "2019-05-18", 8, 12, 2, 1, 1, 18, true)
	TestCalcStartEndTimeStr("2018-04-26", "2019-05-18", 9, 12, 2, 1, 1, 18, true)
	TestCalcStartEndTimeStr("2018-04-26", "2019-05-18", 10, 12, 2, 1, 1, 18, true)
	TestCalcStartEndTimeStr("2018-04-26", "2019-05-18", 11, 12, 2, 1, 1, 18, true)
	TestCalcStartEndTimeStr("2018-04-26", "2019-05-18", 12, 12, 2, 1, 1, 18, false)
	...
	TestCalcStartEndTimeStr("2018-05-16", "2019-06-30", 1, 13, 1, 1, 1, 1, true)
	TestCalcStartEndTimeStr("2018-05-16", "2019-06-30", 2, 13, 2, 1, 1, 1, true)
	TestCalcStartEndTimeStr("2018-05-16", "2019-06-30", 3, 13, 2, 1, 1, 1, true)
	TestCalcStartEndTimeStr("2018-05-16", "2019-06-30", 4, 13, 2, 1, 1, 1, true)
	TestCalcStartEndTimeStr("2018-05-16", "2019-06-30", 5, 13, 2, 1, 1, 1, true)
	TestCalcStartEndTimeStr("2018-05-16", "2019-06-30", 6, 13, 2, 1, 1, 1, true)
	TestCalcStartEndTimeStr("2018-05-16", "2019-06-30", 7, 13, 2, 1, 1, 1, true)
	TestCalcStartEndTimeStr("2018-05-16", "2019-06-30", 8, 13, 2, 1, 1, 1, true)
	TestCalcStartEndTimeStr("2018-05-16", "2019-06-30", 9, 13, 2, 1, 1, 1, true)
	TestCalcStartEndTimeStr("2018-05-16", "2019-06-30", 10, 13, 2, 1, 1, 1, true)
	TestCalcStartEndTimeStr("2018-05-16", "2019-06-30", 11, 13, 2, 1, 1, 1, true)
	TestCalcStartEndTimeStr("2018-05-16", "2019-06-30", 12, 13, 2, 1, 1, 1, true)
	TestCalcStartEndTimeStr("2018-05-16", "2019-06-30", 13, 13, 2, 1, 1, 1, true)

	TestCalcStartEndTimeStr("2016-10-31", "2017-11-30", 1, 13, 1, 1, 1, 1, true)
	TestCalcStartEndTimeStr("2016-10-31", "2017-11-30", 2, 13, 2, 1, 1, 1, true)
	TestCalcStartEndTimeStr("2016-10-31", "2017-11-30", 3, 13, 2, 1, 1, 1, true)
	TestCalcStartEndTimeStr("2016-10-31", "2017-11-30", 4, 13, 2, 1, 1, 1, true)
	TestCalcStartEndTimeStr("2016-10-31", "2017-11-30", 5, 13, 2, 1, 1, 1, true)
	TestCalcStartEndTimeStr("2016-10-31", "2017-11-30", 6, 13, 2, 1, 1, 1, true)
	TestCalcStartEndTimeStr("2016-10-31", "2017-11-30", 7, 13, 2, 1, 1, 1, true)
	TestCalcStartEndTimeStr("2016-10-31", "2017-11-30", 8, 13, 2, 1, 1, 1, true)
	TestCalcStartEndTimeStr("2016-10-31", "2017-11-30", 9, 13, 2, 1, 1, 1, true)
	TestCalcStartEndTimeStr("2016-10-31", "2017-11-30", 10, 13, 2, 1, 1, 1, true)
	TestCalcStartEndTimeStr("2016-10-31", "2017-11-30", 11, 13, 2, 1, 1, 1, true)
	TestCalcStartEndTimeStr("2016-10-31", "2017-11-30", 12, 13, 2, 1, 1, 1, true)
	TestCalcStartEndTimeStr("2016-10-31", "2017-11-30", 13, 13, 2, 1, 1, 1, true)

	TestCalcStartEndTimeStr("2018-03-26", "2019-03-25", 1, 12, 1, 1, 1, 0, true)
	TestCalcStartEndTimeStr("2018-03-26", "2019-03-25", 2, 12, 2, 1, 1, 0, true)
	TestCalcStartEndTimeStr("2018-03-26", "2019-03-25", 3, 12, 2, 1, 1, 0, true)
	TestCalcStartEndTimeStr("2018-03-26", "2019-03-25", 4, 12, 2, 1, 1, 0, true)

	TestCalcStartEndTimeStr("2018-06-06", "2019-06-05", 1, 12, 1, 1, 1, 0, true)
	TestCalcStartEndTimeStr("2018-03-25", "2019-03-24", 1, 12, 1, 1, 0, 0, true)
	TestCalcStartEndTimeStr("2018-03-25", "2019-03-24", 2, 12, 2, 1, 0, 0, true)
	TestCalcStartEndTimeStr("2018-03-25", "2019-03-24", 3, 12, 2, 1, 0, 0, true)
	TestCalcStartEndTimeStr("2018-04-12", "2019-05-17", 1, 13, 1, 1, 1, 18, true)
	TestCalcStartEndTimeStr("2018-04-12", "2019-05-17", 2, 13, 2, 1, 1, 18, true)
	TestCalcStartEndTimeStr("2018-04-26", "2019-06-17", 1, 13, 1, 1, 1, 18, true)
	TestCalcStartEndTimeStr("2018-04-26", "2019-06-17", 2, 13, 2, 1, 1, 18, true)
}
